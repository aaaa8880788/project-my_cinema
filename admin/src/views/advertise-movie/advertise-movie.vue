<template>
  <div class="advertise-manage">
    ...
    <page-table
      ...
      :tableDataTotal="advertiseListTotal"
...
// 取出表格数据
const advertiseList = computed(() => {
  return store.state.home.advertiseListData;
});
const advertiseListTotal = computed(() => {
  return store.state.home.advertiseListTotal;
});
